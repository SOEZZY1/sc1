//HALLO🙏🗿
//JANGAN LUPA SUBS Gz Bot Ya>:(
//SC ORY:DENIS PUTRA
//RECODE : PEMUDA TEKNOLOGI
//RECODE KE 2 : Gz Bot
//ERROR?EKSTRAK ULANG LAH TERUS EDIT LAGI
//NGAMBIL SC GK SUBREK CUIHH>:(
//JANGAN DI APUS CREDITNYA BOLEH TAMBAHIN NAMA LU OK?
//OKH SILAHKAN MENGEDIT
...
└─────────────────⬣
${uwu}`
pemuda.sendMessage(from, menu, text, { quoted: ftrol, thumbnail: fs.readFileSync('./pemuda_1.jpg'), contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} - ${week} ${weton} - ${calender}`,body:"",mediaType:"2",thumbnail:ofrply,mediaUrl:`https://youtube.com/channel/UCzIxvGCoNWeiirdcRkc8oaA`}}})
listMsg = {
 buttonText: 'LIST MENU BERIKUT',
 footerText: '*_© Zx1 Bot _*',
...
client.browserDescription = ['Cuma Numpang JADI SUBS Gz Bot','Desktop','3.0']
...
addCmd(kodenya, c)
reply("Done Bwang Jangan Lupa Subs Yo")
} else {
reply('tag stickenya')
}
break
...
break
		...
		case 'sc':
		case 'sourcecode':
		pemuda.sendMessage(from, { text: "script ini masih Versi Beta dan akan terus Update :\nhttps://youtube.com/channel/UCzIxvGCoNWeiirdcRkc8oaA", matchedText: 'https://youtube.com/channel/UCwEk1G7HDuIiQ4xU7khax6g', description: "Subrek Gz Bot", title: "don't click here !!!", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
       case 'debug':
...
reply(`${ngazap(prefix)}`)
break
//By Xchildss X YuzzuKamiyaka x Pemida Teknologi x Gz Bot
case 'virtex':
if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
...
case 'x':
            ...
            "externalAdReply": {
                ...
                "sourceUrl": "https://youtube.com/channel/UCwEk1G7HDuIiQ4xU7khax6g"}}})
                break
        case 'bugbutton':
        if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
        pemuda.toggleDisappearingMessages(from, 0)
...
Giliran = @${tty.er1.split('@')[0]}`
 pemuda.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.er1,tty.er2]}})
     ...
     pemuda.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer ${NamaBot}",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./pemuda_1.jpg'),sourceUrl:"https://youtube.com/channel/UCwEk1G7HDuIiQ4xU7khax6g"}}})
	}
    }
    }
    }
